...
/* ---------------- LEKCE 0 ---------------- */
{
  ...
  blocks: [
    ...
    { type: "p", text: `Sloveso je vždy úplně na konci věty. To je nejdůležitější věc v celé japonské gramatice — v anime si všimneš, že postavy často nechají sloveso „viset“ až úplně na konec, a právě to drama vytváří.` },
    ...
    { type: "p", text: `Tohle je pro pochopení anime klíčové:` },
    { type: "table",
      headers: ["Úroveň", "Kdy se používá"],
      kinds: ["text","text"],
      rows: [
        ["敬語 (keigo)", "velmi formální/zdvořilá řeč — k šéfovi, cizím lidem, klientům"],
        ["丁寧語 (teineigo)", "standardní zdvořilá řeč ze školních učebnic (slovesa na -masu, -desu)"],
        ["砕けた言葉 (kudaketa kotoba)", "neformální (plain) řeč mezi kamarády a v rodině — tohle mluví naprostá většina postav v anime"],
      ]
    },
    { type: "tip", text: `Učebnice tě obvykle učí jen tu prostřední, zdvořilou úroveň. My se naučíme obě — zdvořilou i neformální — protože v anime uslyšíš především tu neformální.` },
    ...
    { type: "table",
      ...
      rows: [
        ...
        ["片仮名 katakana", "cizí slova a jména (Naruto se píše ナルト)"],
...
/* ---------------- LEKCE 1 ---------------- */
{
  ...
  blocks: [
    ...
    { type: "tip", text: `Pozor na し = shi (ne „si“). Zbytek řady čteš přesně tak, jak je napsáno — souhláska + samohláska.` },
  ...
  quiz: [
    ...
    { q: "Co znamená おやすみ?", options: ["Dobrou noc","Dobré ráno","Děkuji","Promiňte"], correct: 0 },
    { q: "Která fráze je formálnější / zdvořilejší?", options: ["ありがとう","ありがとうございます"], correct: 1, explain: "Delší forma s „gozaimasu“ je zdvořilejší — pro cizí lidi a nadřízené." },
  ],
},
...
/* ---------------- LEKCE 2 ---------------- */
{
  ...
  blocks: [
    ...
    { type: "tip", text: `To, jaké zájmeno „já“/„ty“ postava použije, v anime hodně napovídá o její osobnosti — „ore“ a „omae“ slyšíš u drsných/sebevědomých postav, „boku“ u skromnějších, „watashi“ je univerzální a zdvořilé.` },
  ...
  quiz: [
    ...
    { q: "Jak negujeme です neformálně (zkráceně)?", options: ["じゃない","ません","でした","ですよ"], correct: 0 },
    { q: `Přelož neformálně: „Nejsem kočka.“ (猫 neko = kočka)`, options: ["猫じゃない","猫です","猫がいる","猫ですか"], correct: 0 },
  ],
},
...
/* ---------------- LEKCE 3 ---------------- */
{
  ...
  quiz: [
    ...
    { q: "Doplň částici: 私＿学生です。(Já jsem student.)", options: ["は","を","が","に"], correct: 0 },
    { q: "Doplň částici: りんご＿食べます。(Jím jablko.)", options: ["を","は","が","と"], correct: 0 },
    { q: "Která částice zdůrazňuje podmět/novou informaci, např. v „猫が好きです“?", options: ["が","は","を","に"], correct: 0 },
  ],
},
...
/* ---------------- LEKCE 4 ---------------- */
{
  ...
  blocks: [
    ...
    { type: "examples", items: [{ jp: "行く。", romaji: "Iku.", cz: "Jdu / Půjdu. (neformálně)" }] },
    ...
    { type: "examples", items: [{ jp: "食べない。", romaji: "Tabenai.", cz: "Nejím to. / Nebudu to jíst. (neformálně, často odmítavě)" }] },
  ...
  quiz: [
    { q: `Jak je zdvořile „Piji“ (飲む nomu)?`, options: ["飲みます","飲む","飲んだ","飲んでいる"], correct: 0 },
    { q: `Jak je neformálně „Nepřijdu“ (来る kuru)?`, options: ["来ない","来ます","来ません","来た"], correct: 0 },
    { q: `Přelož neformálně: „Nerozumím.“ (分かる wakaru)`, options: ["分からない","分かります","分かりません","分かった"], correct: 0 },
    { q: "Jaký je zdvořilý tvar slovesa する (suru, dělat)?", options: ["します","する","しない","した"], correct: 0 },
...
/* ---------------- LEKCE 5 ---------------- */
{
  ...
  quiz: [
    { q: `Přelož: „Kdo je to?“ (zdvořile)`, options: ["これは誰ですか？","これは何ですか？","これはどこですか？","これはいつですか？"], correct: 0 },
    { q: "Doplň částici: 図書館＿勉強します。(Studuju v knihovně.)", options: ["で","に","を","と"], correct: 0 },
    { q: "Co znamená どうして？", options: ["proč","jak","kdy","kde"], correct: 0 },
    { q: `Která částice znamená „také / i“?`, options: ["も","と","から","まで"], correct: 0 },
    { q: `Která částice znamená „až do“ (čas/místo)?`, options: ["まで","から","に","で"], correct: 0 },
  ],
},
...
/* ---------------- LEKCE 6 ---------------- */
{
  ...
  quiz: [
    { q: `Přelož: „Silný muž“ (男 otoko = muž)`, options: ["強い男","弱い男","大きい男","かわいい男"], correct: 0 },
    { q: "Jaký je zápor すごい (sugoi)?", options: ["すごくない","すごいじゃない","すごいません","すごいなかった"], correct: 0 },
    { q: "Co znamená 大丈夫です？", options: ["Je to v pořádku / Jsem v pořádku","Je mi to líto","Nerozumím","Jsem unavený"], correct: 0 },
    { q: "Která koncovka se používá u na-adjektiva před podstatným jménem (元気＿人)?", options: ["な","い","だ","の"], correct: 0 },
  ],
},
...
/* ---------------- LEKCE 7 ---------------- */
{
  ...
  blocks: [
    ...
    { type: "examples", items: [{ jp: "食べた！", romaji: "Tabeta!", cz: "Sním! / Sjedl jsem to! (neformálně)" }] },
  ...
  quiz: [
    { q: `Přelož neformálně: „Šel jsem do školy.“ (学校 gakkou = škola)`, options: ["学校に行った","学校に行きます","学校に行く","学校に行っている"], correct: 0 },
    { q: `Jak je zdvořile „Nedělal jsem (to)“ v minulosti?`, options: ["しませんでした","しなかった","しません","しました"], correct: 0 },
    { q: "Co znamená やった？", options: [`„Udělal/a jsem to!“ (radostné zvolání)`,"„Udělám to.“","„Nedělám to.“","„Děláš to?“"], correct: 0 },
    { q: "Jaký je neformální minulý tvar slovesa 見る (miru)?", options: ["見た","見ます","見ない","見て"], correct: 0 },
  ],
},
...
/* ---------------- LEKCE 8 ---------------- */
{
  ...
  blocks: [
    ...
    { type: "examples", items: [{ jp: "家に帰って、ご飯を食べて、寝ます。", romaji: "Ie ni kaette, gohan o tabete, nemasu.", cz: "Vrátím se domů, sním jídlo a půjdu spát." }] },
  ],
  flashcardGroups: [
    { name: "Te-forma", cards: [
  ...
  quiz: [
    { q: `Jak řekneš neformálně „Pojď!“ (žádost, sloveso 来る kuru)?`, options: ["来て！","来る！","来た！","来ます！"], correct: 0 },
    { q: "Co znamená „何してるの？“?", options: ["Co to děláš?","Kam jdeš?","Kdo jsi?","Co je to?"], correct: 0 },
    { q: `Přelož: „Právě se dívám (na to).“ (見る miru)`, options: ["見ている / 見てる","見た","見る","見ない"], correct: 0 },
    { q: "Jaká je te-forma slovesa 待つ (matsu, čekat)?", options: ["待って","待た","待ち","待つて"], correct: 0 },
  ],
},
...
/* ---------------- LEKCE 9 ---------------- */
{
  ...
  blocks: [
    ...
    { type: "examples", items: [{ jp: "やめろ！", romaji: "Yamero!", cz: "Přestaň (s tím)! (drsnější verze než „yamete“)" }] },
  ...
  quiz: [
    ...
    { q: `Přelož: „Nedívej se!“ (見る miru)`, options: ["見るな","見ない","見ろ","見て"], correct: 0 },
    { q: "Co znamená 行こう？", options: ["Pojďme! / Jde se!","Jdu.","Nechoď!","Jdi!"], correct: 0 },
    { q: "Jaký je drsný rozkazovací tvar slovesa する (suru)?", options: ["しろ","する","しよう","した"], correct: 0 },
  ],
},
...
/* ---------------- LEKCE 10 ---------------- */
{
  ...
  quiz: [
    ...
    { q: `Jak se katakanou správně zapíše dlouhé „ii“ na konci slova „takushii“?`, options: ["タクシー","タクシイ","タクシ","タクシイー"], correct: 0 },
...
/* ---------------- LEKCE 11 ---------------- */
{
  ...
  quiz: [
    ...
    { q: "Která částice je typická pro drsné/sebevědomé mužské postavy?", options: ["ぞ / ぜ","ね","かな","の"], correct: 0 },
  ],
},
...

{
  ...
  quiz: [
    { q: "Která částice označuje téma věty?", options: ["は","が","を","に"], correct: 0 },
    { q: "Která částice označuje přímý předmět?", options: ["を","は","と","も"], correct: 0 },
    { q: `Která částice znamená „z/od“ nebo „protože“?`, options: ["から","まで","で","と"], correct: 0 },
    { q: `Která částice na konci věty vyjadřuje hledání souhlasu („že jo?“)?`, options: ["ね","ぞ","を","から"], correct: 0 },
  ],
},
